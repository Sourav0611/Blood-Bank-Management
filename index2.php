...
<?php
   ...
   ?>
    ...
    <header >
        ...
        <div id="logo"> <a href="index2.php"><img src="./Images/LIFE.png"></a>
        </div>
        <div id="nav">
            <div class="header-list" id="headerl">
                ...
                <ul>
                    ...
                    <li><a href="#vol-sect" class="scroll"  target="_self">Donate</a></li>
        ...
        <div class="text-box">
            ...
            <a class="hero-btn" target="self"><?php echo($un);?></a>
            <br><br>
            <a href='logout.php' class="hero-btn" target="_self">Logout</a>
