...
<body>
    ...
    <header>
        ...
        <div id="logo"> <a href="index.php"><img src="./Images/LIFE.png"></a>
        </div>
        <div id="nav">
            <div class="header-list" id="headerl">
                <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    <li><a class="scroll"  onclick="fun()">Services</a></li>
                    <li><a class="scroll" onclick="fun()">About Us</a></li>
                    <li><a class="scroll" onclick="fun()">Volunteer</a></li>
                    <li><a onclick="fun()" target="_self">Donate</a></li>
                    <li><a onclick="fun()" target="_self">Get Help</a></li>
                </ul>
            </div>
        ...
        <div class="text-box">
            ...
            <a href='login.php' class="hero-btn" target="_self">Login</a><br><br>
            <a href='Register.php' class="hero-btn" target="_self">Register</a>
    ...
    <div class="volunteer" section id="vol-sect">
        ...
        <ul class="volunt">
            <li class="vol">
                ...
                <span class=" vol-i name">Akon</span>
            ...
            <li class="vol">
                ...
                <span class=" vol-i name">Bkon</span>
            ...
            <li class="vol">
                ...
                <span class=" vol-i name">Ckon</span>
            ...
            <li class="vol">
                ...
                <span class=" vol-i name">Dkon</span>
            ...
            <li class="vol">
                ...
                <span class=" vol-i name">Ekon</span>
            ...
            <li class="vol">
                ...
                <span class=" vol-i name">Fkon</span>
            ...
            <li class="vol">
                ...
                <span class=" vol-i name">Gkon</span>
            ...
            <li class="vol">
                ...
                <span class=" vol-i name">Hkon</span>
            ...
            <li class="vol">
                ...
                <span class=" vol-i name">Ikon</span>
            ...
            <li class="vol">
                ...
                <span class=" vol-i name">Jkon</span>
                <span class=" vol-i location">Delhi,<br>India</span>
                <span class=" vol-i blood group">B+<i class="fa fa-tint" aria-hidden="true"></i>
                </span>
            </li>
